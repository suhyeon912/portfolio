  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          Hi, I&apos;m{" "}
          <span className="gradient-text glow-text">Suhyeon</span>
        </h1>
        ...
        <p className="max-w-2xl mx-auto text-base sm:text-lg text-gray-400 leading-relaxed mb-10">
          Frontend-first fullstack developer who leverages AI tools to ship
          faster and smarter —{" "}
          <span className="text-gray-200">
            from pixel-perfect React UIs to Spring/Java APIs.
          </span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#work"
            className="group px-7 py-3.5 font-semibold text-white bg-purple-700 hover:bg-purple-600 rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-purple-900/40 hover:-translate-y-0.5 active:translate-y-0"
          >
            View My Work
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 sm:gap-16">
          {[
            ...
            { value: "501K+", label: "Platform Visits" },
          ].map((stat) => (
